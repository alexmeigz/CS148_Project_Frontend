// ReviewUpdatePanel.js
// Engineer: Alex Mei

import React, {useState} from "react";

function ReviewUpdatePanel(props) {
    ...
    function submitUpdatePost(event) {
        ...
        let requiredParams = ["post_id", "post_type", "title", "rating"]
        ...
        <div className="update-form">
            ...
            <form onSubmit={submitUpdatePost}>
                ...
                <div className="form_input">
                    ...
                    <input className="form_field" type="text" value={newInfo.rating} name="rating" onChange={handleChange} />
                </div>
